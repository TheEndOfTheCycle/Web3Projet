            ...
            <?php foreach ($numFilms as $num): ?>
                ...
                <div class="image-container">
                    ...
                    <svg id="seen-icon-<?= $film->num_film ?>" xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                        fill="currentColor" class="bi1 bi-plus-lg watch-list-icon hide-icon " viewBox="0 0 16 16">
                        <path
                    ...
                    <svg id="not-seen-icon-<?= $film->num_film ?>" xmlns="http://www.w3.org/2000/svg" width="25" height="25"
                        fill="currentColor" class="bi2 bi-plus-lg watch-list-icon " viewBox="0 0 16 16">
                        <path
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function () {
                        // Sélectionnez toutes les paires d'icônes de visionnage/non-visionnage
                        const iconPairs = document.querySelectorAll('.image-container');
                        ...
                        iconPairs.forEach(pair => {
                            ...
                            notSeenIcon.classList.add('hide-icon');
