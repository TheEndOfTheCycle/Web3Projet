        ...
        foreach ($liste_acteurs as $acteur):
            ...
            <div class="cat1">
                <?php if ($acteur->nom_img != null): ?>
                    ...
                    <img src="../images/acteurs/<?= $acteur->nom_img ?>" alt="<?= $acteur->nom_real ?>">
                    <?php if (isset($_SESSION['username'])): ?>
                        <!-- Ajoutez un identifiant unique à chaque icône de corbeille, par exemple, "delete-icon-ID" -->
                        <svg id="delete-icon-<?= $acteur->nom_real ?>" xmlns="http://www.w3.org/2000/svg" width="25" height="25"
